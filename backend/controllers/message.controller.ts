...
const GOOGLE_REFRESH_TOKEN = config.get<string>("GOOGLE_REFRESH_TOKEN");
...
const getDrafts = async (req: Request, res: Response) => {
  try {
    ...
    log.error("Can't get drafts ", error.message);
  }
};
...
const readMail = async (req: Request, res: Response) => {
  try {
    ...
    res.send(error.message);
    log.error("Can't read mail ", error.message);
  }
};
...
const getLabel = async (req: Request, res: Response) => {
  try {
...
const getMails = async (req: Request, res: Response) => {
  try {
    ...
    res.send(error.message);
    log.error("Can't get emails ", error.message);
  }
};
