...
const getUser = async (req: Request, res: Response) => {
  try {
    ...
    console.log("Can't get user email data ", (error as Error).message);
    res.send((error as Error).message);
  }
};

const sendMail = async (
  data: { from: string; to: string; label: string },
  token: string
) => {
  try {
    if (!token) {
    ...
    const emailContent = `dont use any name instead use dear user.here you have to create advertisement mail, 
    ...
    Here's a suggested prompt:\n\n'Hello!\n\nWe're thrilled to introduce you to ReachInbox – 
    the ultimate email management platform designed to streamline your communication workflows and 
    boost your productivity.\n\nDiscover how ReachInbox can transform your email experience:\n\n- 
    **Secure Mailing:** Rest assured that your emails are protected with state-of-the-art encryption, 
    keeping your communication private and secure.\n\n- **Automated Emails:** Say goodbye to manual tasks! 
    With ReachInbox, you can automate your email workflows, schedule emails, and set triggers to send 
    messages at the perfect time.\n\n- **Customizable Templates:** Personalize your emails effortlessly! 
    Create stunning templates tailored to your brand and audience, saving you time and effort.\n\n
    ...
    this opportunity to revolutionize your inbox with ReachInbox. Get started today! . 
    give this form of containers heading, features and benefits`;
    ...
    const mailOptions = {
      ...
      html: `<div style="background-color: #f5f5f5; padding: 20px; border-radius: 10px; text-align: center; font-family: Arial, sans-serif;">
...
export { googleRouter, sendMail, getUser };